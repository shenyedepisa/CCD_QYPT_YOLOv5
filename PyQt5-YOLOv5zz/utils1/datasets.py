# YOLOv5 dataset utils1 and dataloaders
...
from utils1.augmentations import Albumentations, augment_hsv, copy_paste, letterbox, mixup, random_perspective
from utils1.general import check_requirements, check_file, check_dataset, xywh2xyxy, xywhn2xyxy, xyxy2xywhn, \
...
def extract_boxes(path='../datasets/coco128'):  # from utils1.datasets import *; extract_boxes()
...
def autosplit(path='../datasets/coco128/images', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from utils1.datasets import *; autosplit()
    Arguments
...
def dataset_stats(path='coco128.yaml', autodownload=False, verbose=False):
    ...
    Usage1: from utils1.datasets import *; dataset_stats('coco128.yaml', verbose=True)
    Usage2: from utils1.datasets import *; dataset_stats('../datasets/coco128.zip', verbose=True)
