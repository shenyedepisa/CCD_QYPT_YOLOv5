...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.comboBox.setStyleSheet("QComboBox QAbstractItemView {\n"
                                    ...
                                    "selection-background-color: rgba(55, 55, 55,150);\n"
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("./icon/摄像头.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.raw_video.setStyleSheet("color: rgb(0, 0, 0);\n"
                                     "")
        ...
        self.out_video.setStyleSheet("color: rgb(0, 0, 0);\n"
                                     "")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "涉密文件辅助检测"))
        self.label_4.setText(_translate("mainWindow", "涉密文件辅助检测"))
