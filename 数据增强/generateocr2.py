...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dst', type=str, default='./data-non/images_gc2', help='destination path')
    ...
    for fileName in fileList:
        ...
        draw3.text((0.3*im.size[0], 0.1*im.size[1]), u'密', fill='blue', font=fnt3)
        ...
        draw8.text((0.1*im.size[0], 0.4*im.size[1]), u'密', fill='purple', font=fnt8)
        ...
        label_path = (args.src).replace('images','labels_gc2')
        label = img_name.replace('images','labels_gc2')
        ...
        centery3 = (0.1*im.size[1]+90/2)/im.size[1]
        centery4 = (0.1*im.size[1]+100/2)/im.size[1]
        centery5 = (0.1*im.size[1]+115/2)/im.size[1]
        centery6 = (0.2*im.size[1]+75/2)/im.size[1]
        centery7 = (0.3*im.size[1]+60/2)/im.size[1]
